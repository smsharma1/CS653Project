...
happyExpList = Happy_Data_Array.listArray (0,25) ([256,32,8,8192,3072,0,48,49160,1,768,0,32768,1,0,0,24,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseCNF","Formula","PartialFormula","Clause","PartialClause","Literal","'p'","int","'-'","'0'","%eof"]
        bit_start = st * 13
        bit_end = (st + 1) * 13
...
action_11 (11) = happyShift action_11
...
action_14 (7) = happyGoto action_13
...
action_18 (7) = happyGoto action_8
...
happyReduction_1 ((HappyAbsSyn5  happy_var_4) `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn4
		 (Formula happy_var_2 happy_var_3 happy_var_4
	) `HappyStk` happyRest
...
happyReduction_2 (HappyAbsSyn6  happy_var_2)
	(HappyAbsSyn6  happy_var_1)
	 =  HappyAbsSyn5
		 (PartialFormula happy_var_1 happy_var_2
	)
...
happyReduction_3 (HappyAbsSyn5  happy_var_2)
	(HappyAbsSyn6  happy_var_1)
	 =  HappyAbsSyn5
		 (PartialFormulaJoined happy_var_1 happy_var_2
	)
...
happyReduction_6 (HappyAbsSyn8  happy_var_2)
	(HappyAbsSyn8  happy_var_1)
	 =  HappyAbsSyn7
		 (PartialClause happy_var_1 happy_var_2
	)
...
happyReduction_7 (HappyAbsSyn7  happy_var_2)
	(HappyAbsSyn8  happy_var_1)
	 =  HappyAbsSyn7
		 (PartialClauseJoined happy_var_1 happy_var_2
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	TokenStartOfFormula -> cont 9;
	TokenInt happy_dollar_dollar -> cont 10;
	TokenNeg -> cont 11;
	TokenEndOfClause -> cont 12;
	_ -> happyError' ((tk:tks), [])
	}
...
happyError' :: () => ([(CNFToken)], [String]) -> HappyIdentity a
